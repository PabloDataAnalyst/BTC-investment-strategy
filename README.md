...
**Data Loading & Cleaning** - Date normalization - NA cleaning - Standardization of return formats - Temporal alignment across datasets

**Equity Curve Construction** - Daily return - Cumulative product - High watermark - Drawdown & Max Drawdown

**Performance KPIs** - Total Return - CAGR - Annualized volatility - Sharpe & Sortino - Profit Factor - Recovery ratio

**Risk Metrics** - Max Drawdown - Ulcer Index - Ulcer Performance Index (UPI) - Winning / losing streaks - Volatility clustering

**Rolling Metrics (key for senior level)** - Rolling Sharpe - Rolling volatility - Rolling drawdown

**Monte Carlo Stress Test** - Resampling of `iv` returns - 5000 simulated paths - Tail risk evaluation (1% and 5% quantiles)

**Benchmark Integration** - Base 100 equity curves - Equivalent KPIs for S&P500 / BTC - Direct equity curve comparison (only BTC used in dashboard)
